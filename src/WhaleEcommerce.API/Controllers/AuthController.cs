...
using WhaleEcommerce.API.Dtos.Account;
...
namespace WhaleEcommerce.API.Controllers
{
    ...
    public class AuthController : MainController
    {
        ...
        public async Task<ActionResult> Register(RegisterUserDto registerUserDto)
        {
            ...
            {
                AddErrorHandler(error.Description);
            }
        ...
        public async Task<ActionResult> Login(LoginUserDto loginUserDto)
        {
            ...
            {
                AddErrorHandler("User temporarily blocked by invalid attempts.");
                return CustomResponse();
            }

            AddErrorHandler("Incorrect user or password.");
            return CustomResponse();
        }
        ...
        private LoginResponseDto GetResponseToken(string encodedToken, IdentityUser user, IEnumerable<Claim> claims)
        {
